...
class AudioMessage:
    ...
    def master_peak(self) -> float | None: ...
...
class AudioEngine:
    ...
    def set_input_learn_active(self, active: bool) -> None: ...
    ...
    def load_sample_async(self, sample_id: int, path: str, run_analysis: bool = True) -> int: ...
