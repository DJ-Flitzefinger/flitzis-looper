...
- And: The `sample_loader` module should be deleted entirely
...
2. Remove import of `sample_loader` module 
3. Remove declaration of `sample_loader` module
4. Delete `src/audio_engine/sample_loader.rs` file
