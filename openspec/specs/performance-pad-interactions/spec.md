...
## Purpose
To specify the mouse interaction model for the performance pad grid: left-click triggers/retriggers a pad, right-click stops it, and middle-click opens a per-pad context menu for pad actions.
## Requirements
