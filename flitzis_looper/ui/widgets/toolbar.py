...
class ToolbarWidget:
    ...
    def _create_right_frame(self) -> None:
        ...
        bpm_entry = tk.Entry(
            ...
            validatecommand=(bpm_validate_cmd, "%P") if bpm_validate_cmd else None,
