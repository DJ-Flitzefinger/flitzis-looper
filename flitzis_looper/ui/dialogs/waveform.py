...
from flitzis_looper.core.state import (
    ...
    get_open_loop_editor_windows, get_loaded_loops, get_current_bank,
    get_multi_loop_active, get_key_lock_active,
    register_open_loop_editor_window, unregister_open_loop_editor_window,
    COLOR_BG, COLOR_TEXT, COLOR_BTN_ACTIVE, COLOR_BTN_INACTIVE,
    COLOR_TEXT_ACTIVE, COLOR_LOCK_OFF,
)
...
class WaveformEditor:
    ...
    def __init__(self, parent, button_id, update_button_label_callback=None, save_config_async_callback=None):
        """
        Args:
