...
def generate_stems(button_id, update_button_label_callback, update_stem_buttons_state_callback, save_config_async_callback):
    """
...
def delete_stems(button_id, update_button_label_callback, update_stem_buttons_state_callback, save_config_async_callback):
    """
