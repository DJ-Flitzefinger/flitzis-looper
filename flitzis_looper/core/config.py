...
from flitzis_looper.core.state import (
    NUM_BANKS,
    get_root, get_all_banks_data, get_button_data, get_current_bank,
    get_master_volume, get_master_amp, get_save_config_timer,
    set_save_config_timer, set_button_data_ref, ensure_stems_structure
)
...
def save_config_async():
    ...
    root = get_root()
    _save_config_timer = get_save_config_timer()
